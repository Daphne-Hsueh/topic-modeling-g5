...
| 2 | Preprocessing | `notebooks/step2_preprocessing.ipynb` (uses `src/step2_preprocess.py`), then `python -m src.step2_keyword_filter` | `data/processed/step2_chunks_clean.csv`, `data/processed/step2_filtered_corpus.csv` |
...
│   └── step2_preprocessing.ipynb        # Clean + chunk the corpus, with QA checks
├── src/
